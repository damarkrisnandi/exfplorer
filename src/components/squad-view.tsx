  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="flex flex-col gap-2 h-full">
        ...
        <div
          className="bg bg-cover bg-center h-[60vh] md:h-screen w-full flex flex-col justify-center items-between  space-y-2 md:space-y-6"
    ...
    <div className="w-full flex flex-col justify-center items-center">
      <Card className="w-full">
        ...
        <CardContent>
          ...
          <div
            className="bg bg-cover bg-center h-[60vh] md:h-screen w-full flex flex-col justify-center space-y-8"
            style={{ backgroundImage: `url('${window.location.origin}/pitch-default.svg')` }}
          >
          </div>
        </CardContent>
