...
export default function DeltaXPointsTop5Visualization() {
  ...
  data.elements.sort((a: Element, b: Element) => ((b.event_points ?? 0) - (b.xp_current ?? 0)) - ((a.event_points ?? 0) - (a.xp_current ?? 0)))
