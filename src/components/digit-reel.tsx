...
export default function DigitReel({ value, className }: DigitReelProps) {
  ...
  return (
    <div className={cn("relative w-12 h-20 md:w-16 md:h-28 overflow-hidden font-twk-everett bg-black", className)}>
            ...
            <div className="flex flex-col items-center">
              {reelDigits.map((digit, index) => (
                <div
                  key={index}
                  className={cn(
                    "text-4xl md:text-7xl font-normal transition-all duration-300 font-twk-everett",
